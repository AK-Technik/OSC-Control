...
if __name__ == "__main__":
        ...
        with open(_x32_lib, "w") as f:
            json.dump({
                ...
                "entities": [
                    ...
                    {"id": "main_mute", "name": "Main Mute", "type": "switch",
                     "osc_path": "/main/st/mix/on", "on_value": 1, "off_value": 0},
                    ...
                    {"id": "dca1_on", "name": "DCA 1 On", "type": "switch",
                     "osc_path": "/dca/1/on", "on_value": 1, "off_value": 0},
                ],
            }, f, indent=2)

    _m32_lib = os.path.join(LIBRARY_DIR, "m32_standard.json")
    if not os.path.exists(_m32_lib):
        with open(_m32_lib, "w") as f:
            json.dump({
                "name": "Midas M32 Standard",
                "device_type": "m32",
                "version": "1.0",
                "entities": [
                    {"id": "main_fader", "name": "Main Fader", "type": "number",
    ...
    _xr18_lib = os.path.join(LIBRARY_DIR, "xr18_standard.json")
    if not os.path.exists(_xr18_lib):
        with open(_xr18_lib, "w") as f:
            json.dump({
                "name": "Behringer XR18 Standard",
                "device_type": "xr18",
                "version": "1.0",
                "entities": [
                    {"id": "lr_fader", "name": "LR Fader", "type": "number",
                     "osc_path": "/lr/mix/fader", "min": 0.0, "max": 1.0},
                    {"id": "lr_on", "name": "LR On", "type": "switch",
                     "osc_path": "/lr/mix/on", "on_value": 1, "off_value": 0},
                    {"id": "ch01_fader", "name": "Kanal 1 Fader", "type": "number",
                     "osc_path": "/ch/01/mix/fader", "min": 0.0, "max": 1.0},
                    {"id": "ch01_mute", "name": "Kanal 1 Mute", "type": "switch",
                     "osc_path": "/ch/01/mix/on", "on_value": 1, "off_value": 0},
                    {"id": "bus01_fader", "name": "Bus 1 Fader", "type": "number",
                     "osc_path": "/bus/01/mix/fader", "min": 0.0, "max": 1.0},
                    {"id": "dca1_fader", "name": "DCA 1 Fader", "type": "number",
                     "osc_path": "/dca/1/fader", "min": 0.0, "max": 1.0},
                ],
            }, f, indent=2)

    _wing_lib = os.path.join(LIBRARY_DIR, "wing_standard.json")
    if not os.path.exists(_wing_lib):
        with open(_wing_lib, "w") as f:
            json.dump({
                "name": "Behringer Wing Standard",
                "device_type": "wing",
                "version": "1.0",
                "entities": [
                    {"id": "main_lr_fader", "name": "Main LR Fader", "type": "number",
                     "osc_path": "/main/lr/fader", "min": 0.0, "max": 1.0},
                    {"id": "main_mono_fader", "name": "Main Mono Fader", "type": "number",
                     "osc_path": "/main/mono/fader", "min": 0.0, "max": 1.0},
                    {"id": "ch01_fader", "name": "Kanal 1 Fader", "type": "number",
                     "osc_path": "/ch/1/fader", "min": 0.0, "max": 1.0},
                    {"id": "ch01_mute", "name": "Kanal 1 Mute", "type": "switch",
                     "osc_path": "/ch/1/mute", "on_value": 1, "off_value": 0},
                    {"id": "dca1_fader", "name": "DCA 1 Fader", "type": "number",
                     "osc_path": "/dca/1/fader", "min": 0.0, "max": 1.0},
                    {"id": "dca1_mute", "name": "DCA 1 Mute", "type": "switch",
                     "osc_path": "/dca/1/mute", "on_value": 1, "off_value": 0},
                ],
            }, f, indent=2)
